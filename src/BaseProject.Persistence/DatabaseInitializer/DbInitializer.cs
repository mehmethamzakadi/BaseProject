...
using BaseProject.Persistence.DatabaseInitializer.Seeders;
...
namespace BaseProject.Persistence.DatabaseInitializer;
...
public sealed class DbInitializer : IDbInitializer
{
    public async Task InitializeAsync(IServiceProvider serviceProvider, CancellationToken cancellationToken = default)
    {
        ...
        var context = scope.ServiceProvider.GetRequiredService<BaseProjectDbContext>();
