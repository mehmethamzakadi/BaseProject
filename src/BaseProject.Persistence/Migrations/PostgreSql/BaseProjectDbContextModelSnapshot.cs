...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BaseProject.Domain.Entities.ActivityLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BaseProject.Domain.Entities.Image", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BaseProject.Domain.Entities.OutboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BaseProject.Domain.Entities.Permission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BaseProject.Domain.Entities.RefreshSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BaseProject.Domain.Entities.RolePermission", b =>
                {
            ...
            modelBuilder.Entity("BaseProject.Domain.Entities.UserRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BaseProject.Domain.Entities.Category", b =>
                {
                    b.HasOne("BaseProject.Domain.Entities.Category", "Parent")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("BaseProject.Domain.Entities.RolePermission", b =>
                {
                    b.HasOne("BaseProject.Domain.Entities.Permission", "Permission")
