...
public class PermissionRepository : EfRepositoryBase<Permission, BaseProjectDbContext>, IPermissionRepository
{
    public PermissionRepository(BaseProjectDbContext context) : base(context)
    {
    }
