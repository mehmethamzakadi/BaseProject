...
public class OutboxMessageRepository : EfRepositoryBase<OutboxMessage, BaseProjectDbContext>, IOutboxMessageRepository
{
    public OutboxMessageRepository(BaseProjectDbContext dbContext) : base(dbContext)
    {
    }
