...
public sealed class UserRepository : EfRepositoryBase<User, BaseProjectDbContext>, IUserRepository
{
    public UserRepository(BaseProjectDbContext context) : base(context)
    {
    }
