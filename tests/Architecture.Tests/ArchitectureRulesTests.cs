...
{
    private const string DomainNamespace = "BaseProject.Domain";
    private const string ApplicationNamespace = "BaseProject.Application";
    private const string InfrastructureNamespace = "BaseProject.Infrastructure";
    private const string PersistenceNamespace = "BaseProject.Persistence";
    private const string ApiNamespace = "BaseProject.API";
    ...
    public void Controllers_Should_Not_Return_Domain_Entities_Directly()
    {
        var result = Types
            .InAssembly(ApiNamespace + ".dll")
            .That()
            .ResideInNamespace("BaseProject.API.Controllers")
            .ShouldNot()
            .HaveDependencyOn("BaseProject.Domain.Entities")
            .Or()
            .HaveDependencyOn("BaseProject.Domain.ValueObjects")
            .GetResult();
    ...
    public void Domain_Service_Interfaces_Should_Be_In_Domain()
    {
        var result = Types
            .InAssembly(DomainNamespace + ".dll")
            .That()
            .ResideInNamespace("BaseProject.Domain.Services")
            .Should()
            .BeInterfaces()
            .GetResult();
    ...
    public void Infrastructure_Service_Implementations_Should_Be_In_Infrastructure()
    {
        var result = Types
            .InAssembly(InfrastructureNamespace + ".dll")
            .That()
            .ResideInNamespace("BaseProject.Infrastructure.Services")
            .Should()
            .BeClasses()
            .GetResult();
