# BaseProject React Client

Modern, production-ready React istemcisi. BaseProject REST API ile tam entegre edilmiş, TypeScript ve modern React teknolojileri kullanılarak geliştirilmiştir.
